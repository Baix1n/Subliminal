...
DEFAULT_AFFIRMATION_CATEGORIES = {
    "self": [
    "\u6211\u5f88\u5b89\u5168\uff0c\u6211\u4e5f\u5f88\u503c\u5f97\u88ab\u7231\u3002",
    "{selfName}\u5141\u8bb8\u81ea\u5df1\u7a33\u5b9a\u3001\u81ea\u7136\u5730\u6210\u4e3a\u88ab\u9009\u62e9\u7684\u4eba\u3002",
    "{selfName}\u7684\u4ef7\u503c\u4e0d\u9700\u8981\u88ab\u4efb\u4f55\u4eba\u7684\u53cd\u5e94\u8bc1\u660e\u3002",
    "{selfName}\u8d8a\u6765\u8d8a\u81ea\u4fe1\uff0c\u8d8a\u6765\u8d8a\u6709\u9b45\u529b\uff0c\u8d8a\u6765\u8d8a\u88ab\u73cd\u60dc\u3002",
    "\u6211\u5c0a\u91cd\u81ea\u5df1\u7684\u611f\u53d7\uff0c\u4e5f\u76f8\u4fe1\u81ea\u5df1\u7684\u5438\u5f15\u529b\u3002",
    "\u6211\u503c\u5f97\u88ab\u770b\u89c1\u3001\u88ab\u6b23\u8d4f\u3001\u88ab\u8ba4\u771f\u5bf9\u5f85\u3002",
    ],
    "relationship": [
    "\u6211\u548c{spName}\u4e4b\u95f4\u7684\u4e92\u52a8\u8f7b\u677e\u3001\u81ea\u7136\u3001\u8212\u670d\u3002",
    "{spName}\u60f3\u5230{selfName}\u65f6\uff0c\u611f\u5230\u6e29\u6696\u3001\u5b89\u5fc3\u548c\u597d\u5947\u3002",
    "{spName}\u8d8a\u6765\u8d8a\u613f\u610f\u9760\u8fd1{selfName}\uff0c\u4e5f\u8d8a\u6765\u8d8a\u73cd\u60dc\u8fd9\u4efd\u8fde\u63a5\u3002",
    "\u6211\u548c{spName}\u4e4b\u95f4\u7684\u6c9f\u901a\u6e05\u6670\u3001\u771f\u8bda\u3001\u987a\u7545\u3002",
    "{selfName}\u4e0d\u9700\u8981\u8ffd\u9010\uff0c\u5173\u7cfb\u4f1a\u4ee5\u5065\u5eb7\u81ea\u7136\u7684\u65b9\u5f0f\u9760\u8fd1\u3002",
    "\u6211\u5c0a\u91cd\u81ea\u5df1\uff0c\u4e5f\u5c0a\u91cd{spName}\u7684\u81ea\u7531\u548c\u611f\u53d7\u3002",
    ],
    "money": [
    "{selfName}\u5141\u8bb8\u81ea\u5df1\u63a5\u4f4f\u66f4\u591a\u673a\u4f1a\u548c\u8d44\u6e90\u3002",
    ...
    "{selfName}\u6bcf\u5929\u90fd\u5728\u9760\u8fd1\u7406\u60f3\u6210\u7ee9\u3002",
    "{selfName}\u76f8\u4fe1\u81ea\u5df1\u7684\u8282\u594f\uff0c\u4e5f\u613f\u610f\u6301\u7eed\u884c\u52a8\u3002",
    "\u9002\u5408{selfName}\u7684\u5b66\u6821\u3001\u673a\u4f1a\u548c\u7ed3\u679c\u6b63\u5728\u9760\u8fd1\u3002",
    ],
    "calm": [
    "\u6211\u5141\u8bb8\u81ea\u5df1\u6162\u4e0b\u6765\uff0c\u8eab\u4f53\u548c\u5185\u5fc3\u90fd\u56de\u5230\u5b89\u5168\u611f\u91cc\u3002",
    "{selfName}\u6b63\u5728\u91ca\u653e\u7d27\u5f20\uff0c\u8fdb\u5165\u5e73\u9759\u3001\u7a33\u5b9a\u3001\u653e\u677e\u7684\u72b6\u6001\u3002",
    "\u6bcf\u4e00\u6b21\u547c\u5438\u90fd\u8ba9{selfName}\u66f4\u5b89\u5fc3\u3002",
    "\u6211\u53ef\u4ee5\u7761\u5f97\u5f88\u6c89\uff0c\u4e5f\u53ef\u4ee5\u9192\u6765\u65f6\u5f88\u6e05\u9192\u3002",
    "\u6211\u4e0d\u9700\u8981\u63a7\u5236\u6240\u6709\u4e8b\u60c5\uff0c\u6211\u53ef\u4ee5\u4fe1\u4efb\u8fc7\u7a0b\u3002",
    "\u5e73\u9759\u6b63\u5728\u6210\u4e3a{selfName}\u81ea\u7136\u7684\u5e95\u8272\u3002",
    ],
    "manifest": [
    "{selfName}\u6e05\u695a\u77e5\u9053\u81ea\u5df1\u60f3\u8981\u4ec0\u4e48\uff0c\u4e5f\u613f\u610f\u63a5\u4f4f\u5b83\u3002",
    "\u6211\u7684\u76ee\u6807\u6b63\u5728\u4ee5\u81ea\u7136\u3001\u987a\u5229\u3001\u53ef\u627f\u53d7\u7684\u65b9\u5f0f\u9760\u8fd1\u3002",
    "{selfName}\u6bcf\u5929\u90fd\u5728\u505a\u51fa\u652f\u6301\u76ee\u6807\u7684\u5c0f\u884c\u52a8\u3002",
    "\u6211\u5141\u8bb8\u597d\u7ed3\u679c\u6765\u5230\u6211\u8fd9\u91cc\u3002",
    "\u673a\u4f1a\u3001\u7075\u611f\u548c\u884c\u52a8\u529b\u6b63\u5728\u652f\u6301{selfName}\u3002",
    "\u6211\u5df2\u7ecf\u5728\u6210\u4e3a\u4e0e\u76ee\u6807\u5339\u914d\u7684\u81ea\u5df1\u3002",
    ],
}
...
class LocalApp(tk.Tk):
    def __init__(self):
        ...
        self.vars = {
            ...
            "affirmation_category": tk.StringVar(value="theme"),
    ...
    def build_affirmation_tab(self, tabs):
        ...
        ttk.Label(frame, text="\u9ed8\u8ba4\u6587\u6848\u5206\u7c7b").grid(row=6, column=0, sticky="w", padx=8, pady=8)
        category_box = ttk.Combobox(
            frame,
            textvariable=self.vars["affirmation_category"],
            values=("theme", "self", "relationship", "money", "study", "calm", "manifest"),
            state="readonly",
        )
    ...
    def selected_default_affirmations(self):
        category = self.vars["affirmation_category"].get()
        if category != "theme":
            return DEFAULT_AFFIRMATION_CATEGORIES.get(category, DEFAULT_AFFIRMATION_CATEGORIES["self"])
        mode = self.vars["intent_mode"].get()
        mapped = {"general": "self", "sp": "relationship", "money": "money", "study": "study"}.get(mode, "self")
        return DEFAULT_AFFIRMATION_CATEGORIES.get(mapped, DEFAULT_AFFIRMATION_CATEGORIES["self"])

    def rendered_default_affirmations(self):
        self_name = self.vars["self_name"].get().strip() or "?"
        sp_name = self.vars["sp_name"].get().strip() or "SP"
        return "\n".join(
            line.replace("{selfName}", self_name).replace("{spName}", sp_name)
            for line in self.selected_default_affirmations()
        )
    ...
    def save_affirmation_state(self, silent=False):
        data = {
            ...
            "affirmation_category": self.vars["affirmation_category"].get(),
    ...
    def load_affirmation_state(self, silent=False):
        ...
        try:
            ...
            return
        for key in ("intent_mode", "affirmation_mode", "affirmation_category", "self_name", "sp_name"):
            if key in data:
